...
WebUI.click(findTestObject('Object Repository/Page_React App/span_Send'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_React App/div_Please fill in a message'))
